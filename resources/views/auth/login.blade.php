                    ...
                    <div class="py-5">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                ...
                                <x-input id="email"  placeholder="Email" class="block mt-1 w-full" type="email" name="email" class="block mt-1 w-full bg-gray-800 border-gray-500"
                                    :value="old('email')" required />
                            </div>
                        <div  class="flex  justify-between  my-5">
                            <!-- Password -->
                            <div class="mt-4 sm:w-9/12  w-6/12">
                                <x-label for="password" />

                                <x-input id="password"  placeholder="Mot de passe" class="block mt-1 w-full" type="password" name="password"  class="block mt-1 w-full bg-gray-800 border-gray-500"
