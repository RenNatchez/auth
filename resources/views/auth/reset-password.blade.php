                    ...
                    <div class="py-5">
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div>
                                ...
                                <x-input placeholder='Email' id="email" class="block mt-1 w-full  bg-gray-800 border-gray-500" type="email" name="email" :value="old('email', $request->email)" required autofocus />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input  placeholder='Nouveau mot de passe' id="password" class="block mt-1 w-full  bg-gray-800 border-gray-500" type="password" name="password" required />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input placeholder='Confirmer le mot de passe' id="password_confirmation" class="block mt-1 w-full  bg-gray-800 border-gray-500"
                                                    type="password"
